...
package com.example.ecommerce.domain.mock;
...
public class FakeWebServer {
    ...
    ArrayList<ProductCategoryModel> listOfCategory;
    ...
    public void getAllElectronicsFirestore()
    {
        ...
        firestore.collection("Categories")
                .document("Electronic").collection("Products").get().addOnSuccessListener(new OnSuccessListener<QuerySnapshot>() {
            @Override
            public void onSuccess(QuerySnapshot queryDocumentSnapshots) {

                for(DocumentSnapshot snapshot: queryDocumentSnapshots)
                {
                    myData myData = snapshot.toObject(com.example.ecommerce.model.entities.myData.class);
                    firestore.collection("Categories")
                            .document("Electronic")
                            .collection("Products")
