...
import com.example.ecommerce.util.ColorGenerator;
...
import com.example.ecommerce.view.adapter.SimilarProductsPagerAdapter;
import com.example.ecommerce.view.customview.ClickableViewPager;
import com.example.ecommerce.view.customview.ClickableViewPager.OnItemClickListener;
import com.example.ecommerce.view.customview.LabelView;
import com.example.ecommerce.view.customview.TextDrawable;
import com.example.ecommerce.view.customview.TextDrawable.IBuilder;
...
public class ProductDetailsFragment extends Fragment {
                ...
                new OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        if (isFromCart) {
                            ...
                            // current object......................
                            Product tempObj = ProductOverviewFragment.productMap
                            ...
                            if (CenterRepository.getCenterRepository()
                                ...
                                ((ECartHomeActivity) getContext()).updateCheckOutAmount(
                                        BigDecimal.valueOf(Long
                                                .valueOf(ProductOverviewFragment.productMap
                                                        .get(subcategoryKey)
                                                        .get(productListNumber)
                                                        .getSellMRP())), true);
    ...
    public void fillProductData() {
        ...
        if (!isFromCart) {
            ...
            itemName.setText(ProductOverviewFragment.productMap.get(subcategoryKey).get(productListNumber)
                    .getItemName());

            quanitity.setText(ProductOverviewFragment.productMap.get(subcategoryKey).get(productListNumber)
                    .getQuantity());

            itemdescription.setText(ProductOverviewFragment.productMap.get(subcategoryKey).get(productListNumber)
                    .getItemDetail());

            String sellCostString = Money.rupees(
                    BigDecimal.valueOf(Long.valueOf(ProductOverviewFragment.productMap
                            .get(subcategoryKey).get(productListNumber)
                            .getSellMRP()))).toString()
                    + "  ";
            ...
            drawable = mDrawableBuilder.build(
                    String.valueOf(ProductOverviewFragment.productMap.get(subcategoryKey)
                            .get(productListNumber).getItemName().charAt(0)),
                    mColorGenerator.getColor(ProductOverviewFragment.productMap
                            .get(subcategoryKey).get(productListNumber)
                            .getItemName()));

            Picasso.with(getActivity())
                    .load(ProductOverviewFragment.productMap
                            .get(subcategoryKey).get(productListNumber)
            ...
            label.setText(ProductOverviewFragment.productMap
