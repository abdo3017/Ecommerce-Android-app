...
public class CategoryListAdapter extends
    ...
    public CategoryListAdapter(Context context,ArrayList<ProductCategoryModel>arrayList) {

        categoryList = new ArrayList<>(arrayList);
        Toast.makeText(context, categoryList.size()+" -> Constructor", Toast.LENGTH_SHORT).show();
