...
public class ProductListAdapter extends
    ...
    public ProductListAdapter(String subcategoryKey, Context context,
        ...
        if (isCartlist) {
            ...
            Toast.makeText(context, "here111", Toast.LENGTH_SHORT).show();
        } else {

            productList = ProductOverviewFragment.productMap.get(subcategoryKey);
            Toast.makeText(context, "here22   "+productList.size()+",.mlm", Toast.LENGTH_SHORT).show();
        }
